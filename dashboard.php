...
<body>
    <header class="col-md-12" style="background-color: #c92020; color: white; text-align: left; padding: 10px;">
            ...
            <img src="asset/sfaulogo.png" alt="Logo" style="max-width: 80px; max-height: 50px;">
            <h3 style="display: inline-block; margin-left: 0px;">Camarines Norte State Scholarship Financial and Assistance Unit</h3>
    </header>
